...
{
  "id": "system-solve-infinite-solutions",
  "level": "2",
  "url": "sec22-solving-systems.html#system-solve-infinite-solutions",
  "type": "Activity",
  "number": "2.2.4",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#3d-system-infinite-solution",
  "type": "Figure",
  "number": "2.2.6",
  "title": "",
...
{
  "id": "system-solve-no-solutions",
  "level": "2",
  "url": "sec22-solving-systems.html#system-solve-no-solutions",
  "type": "Activity",
  "number": "2.2.5",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#3d-system-no-solution",
  "type": "Figure",
  "number": "2.2.7",
  "title": "",
  "body": " 3D System of Equations   "
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#augmented-matrices-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "solution "
...
{
  "id": "possible-solution-types",
  "level": "2",
  "url": "sec22-solving-systems.html#possible-solution-types",
  "type": "Proposition",
  "number": "2.2.9",
  "title": "Solutions to Systems of Linear Equations.",
  "body": " Solutions to Systems of Linear Equations  Given a set of linear equations, there are only the following possibilities for solutions to the system:   There is exactly one solution.    There are infinitely many solutions.    There are no solutions.     "
},
{
  "id": "augmented-matrices-12",
  "level": "2",
  "url": "sec22-solving-systems.html#augmented-matrices-12",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#act-identify-solution-spaces",
  "type": "Activity",
  "number": "2.2.6",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#reduced-row-echelon-2-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#reduced-row-echelon-2-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#act-matrix-reduce-rref",
  "type": "Activity",
  "number": "2.2.7",
  "title": "",
  "body": "  Consider a system of equations whose augmented matrix is row equivalent to      This system has an infinite number of solutions. Suppose we want to generate solutions to this system. Describe a process for generating the solutions. What variables are \"free\" to be used to generate the other variables?      Since the first and second columns contain zeros in the last two rows, we cannot multiply the second or thrid rows by a scalar and add them to the first row to place zeros in either of the first two positions of the first row (we are stuck with the 1 and 4 in those positions). However, the second row has a 1 and -1 in the third and fourth position, respectively. This means we could use the second row to further reduce the third or fourth positions in first row to zero. This would make back-solving even easier when the time comes.  Using row operations with row 2, try to reduce this matrix further to place a zero in the first row at the third position. Explain your process.      Using row operations with row 2, try to reduce the matrix from part (b) further to place a zero in the first row at the fourth position. Explain your process. Describe any issues you encounter.      Can you reduce the original matrix to have zeros in the first row in both the third and fourth positions?    "
},
{
  "id": "reduced-row-echelon-5",
  "level": "2",
  "url": "sec22-solving-systems.html#reduced-row-echelon-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec22-solving-systems.html#reduced-row-echelon-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "reduced-row-echelon-7",
  "level": "2",
  "url": "sec22-solving-systems.html#reduced-row-echelon-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "row reduced echelon form (rref) rref "
},
{
  "id": "reduced-row-echelon-8",
  "level": "2",
  "url": "sec22-solving-systems.html#reduced-row-echelon-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
