...
{
  "id": "sec21-gridding-space-5-4-1",
  "level": "2",
  "url": "sec21-gridding-space.html#sec21-gridding-space-5-4-1",
  "type": "Activity",
  "number": "2.1.3",
  "title": "",
...
{
  "id": "sec21-gridding-space-5-7",
  "level": "2",
  "url": "sec21-gridding-space.html#sec21-gridding-space-5-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "finding-scalars-10",
  "level": "2",
  "url": "sec22-solving-systems.html#finding-scalars-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "finding-scalars-11-1",
  "level": "2",
  "url": "sec22-solving-systems.html#finding-scalars-11-1",
  "type": "Activity",
  "number": "2.2.1",
  "title": "",
  "body": "  Consider the following system of equations.        Use the process of Gaussian elimination to reduce the system of 3 equations and 3 unknowns to a system of 2 equations and 2 unknowns by scaling and\/or adding pairs of these equations.      Now eliminate another of your two remaining variables from part (a) in similar manner (scaling and\/or adding pairs of these equations) to find a solution value for one of the three variables.      Use your value from part (b) and one of your equations found in part (a) to solve for a second unknown.      Use the two values you have found so far along with one of your original equations to solve for the last unknown.      Use the GeoGebra applet in to verify your solution to the system. Feel free to rotate the planes so that the intersection point of all three is visible.    "
},
{
  "id": "3d-system-gbra",
  "level": "2",
  "url": "sec22-solving-systems.html#3d-system-gbra",
  "type": "Figure",
  "number": "2.2.4",
  "title": "",
