...
{
  "id": "stripping-variables-22-1",
  "level": "2",
  "url": "sec22-solving-systems.html#stripping-variables-22-1",
  "type": "Activity",
  "number": "2.2.3",
  "title": "",
  "body": "  Consider the following system of equations.      Convert the system of equations into an augmented matrix.      Use Gaussian Elimination to reduce your augmented matrix to one that is in upper triangular form. Be sure to indicate your process at each stage by using notation such as .      After you have solved for one of the values of the unknowns, back-solve to find the remaining unknown values.    "
},
{
